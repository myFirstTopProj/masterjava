...
package ru.javaops.masterjava.xml.newschema;
 ...
 * generated in the ru.javaops.masterjava.xml.newschema package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.javaops.masterjava.xml.newschema
     * 
     */
    ...
    @XmlIDREF
    public JAXBElement<List<Object>> createGroupUsersUser(List<Object> value) {
        return new JAXBElement<List<Object>>(_GroupUsersUser_QNAME, ((Class) List.class), Group.Users.class, ((List<Object> ) value));
    }
